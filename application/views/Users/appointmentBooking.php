    ...
    <div class="row">
      ...
      <?php if(isset($doctors) && ($doctors!=='')):?>
        ...
        <?php if (!isset($doctors[0]['coupon_id'])) : ?>
          ...
          <h4>Select from the best doctors in <?php //echo $hos_name ?> Hospital</h4>


        <?php else : ?>

          <h4><?php echo $doctors[0]['hos_name'] ?> Hospital</h4>
              ...
              <div class="card p-2 <?php echo $x['doc_id'] . '-card'; ?> card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-6 m-0 p-1">
                    ...
                    <p class="m-0 p-0" style="font-size:12px;"><?php //echo $x['dept_name'] ?> <small style="" class="text-muted">over 12 years of experience</small></p>
                ...
                <div id="input" class="row justify-content-center">
                  ...
                  <div class="col-10 col-sm-10 col-md-8 col-lg-8">
                    ...
                    <div class="form-group">
                      ...
                      <img src="<?php echo base_url('userUploads/'.$x['picture'] ) ?>" style="height:130px;width:120px;" class="float-left mr-4 img-thumbnail rounded-square" alt="">



                      <input type="hidden" name="pt_name" id="uname" value="<?php echo $userData[0]['name'] ?>"><br>
                      <p><strong>Doctor's Name</strong>: <?php echo $x['doc_name'] ?>

                        <!-- <br><strong>Email ID</strong>: <?php //echo $x['email_id'] ?> -->
                  ...
                  <div class=" row pr-2 mt-3">
                    ...
                    <div class="col-4 col-sm-4 col-md-3 col-lg-3">
                      ...
                      <p class="shifts text-muted ml-1">Appointment&nbsp;For&nbsp;<span class="text-danger">*</span></p>
                    ...
                    <div class="col-4 col-sm-4 col-md-3 col-lg-3 hidden" style="display: none;">
                      ...
                      <p class="shifts text-muted">Patient Name&nbsp;<span class="text-danger">*</span></p>

                    </div>

                    <div class="col-8 col-sm-8 col-md-9 col-lg-9 hidden" style="display: none;"><input type="text" name="pt_name" class="form-control col-6" />
                    ...
                    <div class="col-4 col-sm-4 col-md-3 col-lg-3">
                      ...
                      <p class="shifts text-muted ml-2">Appointment&nbsp;Date&nbsp;<span class="text-danger">*</span></p>
                    ...
                    <div class="col-8 col-sm-8 col-md-9 col-lg-9"><input type="text" name="date" class="input-calendar<?php echo $x['doc_id'] ?> form-control col-6" id="calendar<?php echo $x['doc_id'] ?>" value="<?php echo mdate($datestring, $curtime) ?>" />
                    ...
                    <div id="slots<?php echo $x['doc_id'] ?>" class="slots row justify-content-center">
                      ...
                      <div class="col-8 col-sm-8 col-md-9 col-lg-9">
                        ...
                        ?>
                          ...
                          <?php if (!in_array($z, $bookSlots[$x['doc_id']]) && $brk[0] > $time[0]) { ?>

                            <input type="radio" name="slot" id="bfr<?php echo $y . $x['doc_id'] ?>" id='checkdata' required value="<?php echo $z ?>">
                            <label for="bfr<?php echo $y . $x['doc_id'] ?>"><?php echo $z ?></label>
