         ...
         <div class="row">
             ...
             <div class="col-sm-8 bg-body consultData" data-aos="flip-up">
                 ...
                 <form class="d-flex">
                     ...
                     <input class="form-control me-2" id="myInput" type="search" onkeyup="searchFunction()" placeholder="Search by treatment, query.." aria-label="Search">
                                     ...
                                     <?php if ($rs['answer'] != NULL) : ?>
                                         ...
                                         <div id="show-data" style="display:none;">
                                             ...
                                             <div class="row" style="flex-direction:column; margin-left:12px;">
                                                 ...
                                                 <img src="<?= $rs['doc_pic'] ?>" class="img-thumbnail ml-1 mr-1 float-right rounded-circle" style="height: 50px; width:50px;" alt="">
 ...
 -->
     ...
     <script>
         ...
         function searchFunction() {
             ...
             var input, filter, cards, a, b, i, txtValuea, txtValueb;
             ...
             for (i = 0; i < cards.length; i++) {
                 ...
                 a = cards[i].getElementsByClassName("query-title")[0];

                 b = cards[i].getElementsByClassName("query")[0];
