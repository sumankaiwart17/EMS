    ...
    <div class="main">
         ...
         <div class="float-left"><a class="log-btn ml-2 text-primary" href="<?php echo site_url('doctor/doctor-login') ?>">Already Registered? Login</a></div>
            ...
            <div class="login-form">
               ...
               <form action="<?php echo site_url('doctorProfile_Controller/register') ?>" method="post">
                  ...
                  <div class="form-group">
                     ...
                     <input type="email" class="form-control" name="email" placeholder="Email ID" value="<?php echo set_value('email') ?>" required>
                  ...
                  <div class="form-group">
                     ...
                     <input type="number" class="form-control" name="adhar" placeholder="Aadhaar Card Id" value="<?php //echo set_value('hos_name') ?>" required>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group ">
                     ...
                     <input type="number" class="form-control" name="docId" placeholder="Enter medical council registrations number" value="<?php //echo set_value('zip') ?>" required>
                  ...
                  <div class="form-group ">
                     ...
                     <input type="text" class="form-control" name="zip" placeholder="Pincode" value="<?php //echo set_value('zip') ?>" required>
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" name="city" placeholder="City" value="<?php //echo set_value('city') ?>" required>
...
<option value="West Bengal">West Bengal</option>
                  ...
                  <div class="form-group">
                     ...
                     <!-- <input type="text" class="form-control" name="country" placeholder="Country" value="<?php //echo set_value('state') ?>">
...
<option value="Zimbabwe">Zimbabwe</option>
                  ...
                  <div class="form-group">
                     ...
                     <input type="tel" class="form-control" name="phone" placeholder="Phone No." value="<?php //echo set_value('phone') ?>" required>
                ...
                <div class="form-group ">
                     ...
                     <!-- <input type="text" class="form-control" name="degree" placeholder="Degree" value="<?php //echo set_value('degree') ?>"> -->
                  ...
                  <div class="form-group" style="display:none"  id="dis_specialization">

                     <label >Specialization<label style="color:red">*</label></label>

                     <!-- <input type="text" class="form-control" name="speciality" placeholder="Speciality" value="<?php //echo set_value('speciality') ?>">

                     <span class="text-danger"><?php //echo form_error('speciality') ?></span> -->

                      <select class="form-control" name="specialization" id="u_degree" onchange="get_speciality()" >
                   ...
                   <div class="form-group" style="display:none" id="dis_speciality">
                     ...
                     <label>Speciality<label style="color:red">*</label></label>
                      ...
                      <select class="form-control" name="speciality" id="Speciality_always_show">
                                        <option value="">Select</option>
                      </select>
                  ...
                  <div class="form-group ">
                     ...
                     <input type="text" class="form-control" name="experience" placeholder="Years of experience" value="<?php //echo set_value('experience') ?>" required>
                  ...
                  <div class="form-group ">
                     ...
                     <input type="text" class="form-control" name="zip" placeholder="About" value="<?php //echo set_value('About') ?>">
 ...
 $('#doc_degree').change(function(){
    ...
    //alert($(this).val());
        ...
        // success: function (data) {
            ...
            if(degree_data == "UG")
            {
                // document.getElementById('u_degree').style.display='block';
             ...
             $("#u_degree").find("option").remove().end().append(
         selOptn)
                // $('#u_degree').append(selOptn);
            }
            if(degree_data == "PG" )
            {
                ...
                // document.getElementById('always_show').style.display='none';
                // document.getElementById('s_degree').style.display='none';
                // document.getElementById('u_degree').style.display='none';
                // console.log(data) ;
                selOptn = 
                "<option value=''>Select</option>"+
    ...
    function get_speciality(){
        var special_val = document.getElementById("u_degree").value;
        // alert(special_val)
        ...
        if(special_val=="MBBS" || special_val=="BAMS "|| special_val=="BHMS " || special_val==""|| special_val=="BDS" ||special_val=="BUMS" || special_val=="BYNS"|| special_val=="B.V.Sc & AH" )
        {
        ...
        if(special_val=="MD"){
            selOptn = 
                 ...
                 $("#Speciality_always_show").find("option").remove().end().append(selOptn) 

                 //$('#Speciality_always_show').append(selOptn);
        }
         if(special_val=="MS"){
            selOptn = 
