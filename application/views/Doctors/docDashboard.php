				...
				<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
					...
					<div class="dash-widget">
						...
						<div class="dash-widget-info text-right">
							...
							<h3>123<?php //echo count($assocDoc) 
									...
									<tbody>
										...
										<tr>
											...
											<td style="min-width: 200px;">
												...
												<h2><a href="#">Kothari Hospital</a></h2>
											...
											<td>
												...
												<p> 02-05-2021<?php //echo $x['appt_slot_time'] 
					...
					<div class="card member-panel">
						...
						<div class="card-body">
							...
							<ul class="contact-list">
								...
								<li><input type="checkbox" name="" id=""> Apollo</li>

								<li><input type="checkbox" name="" id=""> Kothari Hospitals</li>
								...
								<!-- <li>
                                        ...
                                        <div class="contact-cont">
                                            ...
                                            <div class="float-left user-img m-r-10">
                                                ...
                                                <a href="profile.html" title="John Doe"><img src="<?php // echo $x['picture'] 
                                            ...
                                            <div class="contact-info">
                                                ...
                                                <span class="contact-name text-ellipsis"><?php //echo $x['doc_name'] 

																							?></span>

                                                <span class="contact-date"><?php //echo $x['specialization'] 
						...
						<!-- <div class="card-footer text-center bg-white">
                                ...
                                <a href="<?php //echo site_url('hospital_Controller/doctors') 

											?>" class="text-muted">View all Doctors</a>
