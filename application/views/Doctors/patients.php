										...
										<!-- <td data-th="Action:" class="text-right">
											...
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													 ...
													 <a class="dropdown-item" href="<?php // echo site_url('hospital_controller/editPatient/'.$x['p_id']) 
											...
											<div class="mob-action text-left">
													...
													<a class="" href="<?php // echo site_url('hospital_controller/editPatient/'.$x['p_id']) 
