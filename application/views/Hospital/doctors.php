...
if(isset($_POST['submit'])){
	...
	$file="https://projects.dotlinkertech.com/aahrs/upload/".$rand.$_FILES['file']['name'];
	...
	$result = curl_exec($ch);
	 if ($result == '{"errors":[{"title":"Invalid image_url: Please provide a valid URL.","code":"invalid_image_url"}]}' || $result == '{"errors":[{"title":"Failed to download image from given image_url: HTTP Status 404","code":"failed_image_download"}]}') {
        echo 'error';
    }
    else{
	curl_close($ch);
