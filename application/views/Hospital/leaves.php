        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-9 text-right m-b-20">
                    ...
                    <a href="<?php echo site_url('Hospital_Controller/addLeaves') ?>"
                        class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Add Leave</a>
                        ...
                        <table class="table table-striped custom-table mb-0 datatable">
                            ...
                            <tbody>
                                ...
                                <tr style="margin-bottom: 5px;">
                                    ...
                                    <?php if ($x['stat']) : ?><td data-th="Status:"><span
                                        ...
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item"
                                                    href="<?php echo site_url('hospital_Controller/editLeave/' . $x['id']) ?>"><i
                                                        class="fas fa-pencil-alt m-r-5"></i> Edit</a>

                                                <a class="dropdown-item"
                                                    href="<?php echo site_url('hospital_Controller/delLeave/' . $x['id']) ?>"
                    ...
                    <form method="post" action="<?php echo site_url('hospital_Controller/addLeavesdata') ?>">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="emp_id" name="emp_id" required class="form-control">
                                        ...
                                        <option value="<?php echo $x['emp_id'] ?>"><?php echo $x['emp_name'] ?></option>
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="4" cols="5" class="form-control" name="reason" id="reason"></textarea>
        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <form method="post" action="<?php echo site_url('hospital_Controller/editLeave') ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" readonly="" type="text" name="emp_name"
                                        value="<?php echo $leaveData[0]['emp_name']; ?>">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" readonly="" type="text" id="emp_id" name="emp_id"
                                        value="<?php echo $leaveData[0]['emp_id']; ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" required class="form-control" name="from_date"
                                        value="<?php echo $leaveData[0]['from_date']; ?>" id="efrom_date">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" required class="form-control" name="to_date"
                                        value="<?php echo $leaveData[0]['to_date']; ?>" id="eto_date">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" readonly="" type="text" id="eno_days"
                                        value="<?php echo $leaveData[0]['no_days']; ?>" name="no_days">
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="4" cols="5" required class="form-control" name="reason"
                                    id="reason"><?php echo $leaveData[0]['reason']; ?></textarea>
