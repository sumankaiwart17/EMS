...
<body>
    ...
    <div class="main">
        ...
        <div class="multipleSelection " style = "
			">
            <div class="selectBox" 
                onclick="showCheckboxes()" style = "position: relative;">
			...
			border: 1px #ced4da solid;">
                <label for="first" style = "display: block; margin-left:15px">
                    <input type="checkbox" id="first" />
                    checkBox1
                </label>
                  
                <label for="second"  style = "display: block; margin-left:15px">
                    <input type="checkbox" id="second" />
                    checkBox2
                </label>
                <label for="third"  style = "display: block; margin-left:15px">
                    <input type="checkbox" id="third" />
                    checkBox3
                </label>
                <label for="fourth"  style = "display: block; margin-left:15px">
