        ...
        <div class="page-wrapper">
            ...
            <div class="content">
                ...
                <div class="row filter-row">
                    ...
                    <label style="font-size: 20px; margin-left: 15px; margin-top: 4px;">Offers On:</label>

                    <div class="col-sm-6 col-md-4">

                        <div class="form-group select-focus">

                            <select id="offer_on" required class="select floating form-control">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 pt-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="aoffer_on">Offer On:<span class="text-danger">*</span></label>

                                        <select id="aoffer_on" name="offer_on" required class="form-control">

                                            <option value="">Select an option</option>

                                            <option <?php if (isset($offer) && $offer[0]['offer_on'] == 'Doctor') {

                                                        echo 'selected';

                                                    } ?> value="Doctor">Doctor</option>

                                            <option <?php if (isset($offer) && $offer[0]['offer_on'] == 'Treatment') {

                                                        echo 'selected';

                                                    } ?> value="Treatment">Treatment</option>
                                ...
                                <div class="col-sm-6 pt-2 adoc" style="display: none">
                                ...
                                <div class="col-sm-6 pt-2 atrat" style="display: none">

                                    <div class="form-group">

                                        <label>Treatment: <span class="text-danger">*</span></label>

                                        <select name="treat_id" class="form-control rtrat">
                                ...
                                <div class="col-sm-6 pt-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" required name="coupon_title" value="<?php if (isset($offer)) {

                                                                                                            echo $offer[0]['coupon_title'];

                                                                                                        } ?>" id="coupon_title" type="text">
                                ...
                                <div class="col-sm-6 pt-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" required type="number" min="1" name="discount" >
            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 offset-lg-2 pt-3">
                        ...
                        <form method="post" action="<?php echo site_url('hospital_Controller/editOffer') ?>">
