...
<body>
    ...
    <button type="button" class="btn btn-primary">Save changes</button>
                ...
                <div class="row filter-row">
                    ...
                    <label style="font-size: 20px; margin-left: 15px; margin-top: 4px;"><small>Search Appointment</small></label>
                    <input type="text" class="search form-control ml-3 mb-3" style="width: 250px;" placeholder="Search...">
                    <label style="font-size: 20px; margin-left: 15px; margin-top: 4px;"><small>Search By Date</small></label>
                    <div class="col-sm-6 col-md-3">
                        <input type="date" class="searchdate form-control ml-2 mb-3" style="width: 250px;">
                                        ...
                                        if (isset($appointments)) :
                                            ...
                                            foreach ($appointments as $x) { ?>
                                                ...
                                                <tr style="margin-bottom: 5px;">
                                                    ...
                                                    <td data-th="Department:"><?php echo $x['dept_name']; 
                                                                                ?></td>
