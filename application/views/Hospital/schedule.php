            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-3" data-aos="fade-right">
                        ...
                        <input type="text"class="form-control mb-3"placeholder="Search Schedule" style="width:250px" id="search">
                    </div>
                                    ...
                                    <?php if (isset($doctors)) {
                                        ...
                                        foreach ($doctors as $x) : ?>
                                            ...
                                            <tr style="margin-bottom: 5px;">
                                                ...
                                                <td><img width="28" height="28" src="<?php echo $x['picture'] ?>" class="rounded-circle m-r-5" alt=""> <?php echo $x['doc_name'] ?></td>

                                                <td data-th="Department Name:"><?php echo $x['specialization'] ?></td>
                                                ...
                                                <td data-th="Action:" class="text-right">
                                                    ...
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item" href="<?php echo site_url('hospital_Controller/delSchedule/' . $x['doc_id']) ?>" onclick="return confirm('Are you sure, you want to delete it?')"><i class="fas fa-trash m-r-5"></i> Delete</a>
                                ...
                                <div class="row pt-3 pb-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="doc_id" class="form-control" required>
                                                ...
                                                <?php foreach ($doctors as $x) : ?>
                                                    ...
                                                    <option  value="<?php echo $x['doc_id'] ?>" required><?php echo $x['doc_name'] ?></option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="weekdays[]" size="6" id="choices-multiple-remove-button" required placeholder="Select Days" multiple>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="time-icon">
                                                ...
                                                <input name="strt_time" type="text" class="form-control" id="datetimepicker3" required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="time-icon">
                                                ...
                                                <input name="end_time" type="text" class="form-control" id="datetimepicker4" required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="time-icon">
                                                ...
                                                <input name="brk_time" type="text" class="form-control" id="datetimepicker5" required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                ...
                                                <input name="brk_dur" type="number" class="form-control" id="brk_dur" required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                ...
                                                <input name="appt_dur" type="number" class="form-control" id="brk_dur" required>
                ...
                <?php if (isset($schedule)) : ?>
                    ...
                    <div class="row p-3">
                        ...
                        <div class="col-lg-8 offset-lg-2">
                            ...
                            <form action="<?php echo site_url('hospital_Controller/editSchedule') ?>" method="post">
