            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20" data-aos="fade-left">
                        <a href="<?php echo site_url('doctor/add-doctor-schedule') ?>" class="btn btn btn-success btn-rounded float-right"><i class="fa fa-plus"></i> Add Schedule</a>
                    </div>
                </div>
                                                ...
                                                <td data-th="Status:"><?php if ($x['status'] != 0) : ?><span class="custom-badge status-green">Active</span><?php else : ?><span class="custom-badge status-red">Inactive</span><?php endif; ?></td>
                                                    ...
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="<?php echo site_url('doctorProfile_Controller/editSchedule/' . $x['doc_id']) ?>"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
                                                            <a class="dropdown-item" href="<?php echo site_url('doctorProfile_Controller/delSchedule/' . $x['doc_id']) ?>" id="deleteSchedule" onclick="return confirm('Are you sure you want to delete this schedule ?')"><i class="fas fa-trash m-r-5"></i> Delete</a>
                                                        </div>
                                                    </div>

                                                    <div class="mob-action text-left">
                                                        <a class="" href="<?php echo site_url('doctorProfile_Controller/editSchedule/' . $x['doc_id']) ?>"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
                                                        <a style="padding: 27px;" class="" href="<?php echo site_url('doctorProfile_Controller/delSchedule/' . $x['doc_id']) ?>" onclick="return confirm('Are you sure, you want to delete it?')"><i class="fas fa-trash m-r-5"></i> Delete</a>
                                                    </div>
                                                </td>
                ...
                <?php if (isset($doctors)) : ?>
                    ...
                    <div class="row p-3">
                        <div class="col-lg-8 offset-lg-2">
                            <form action="<?php echo site_url('doctorProfile_Controller/addSchedule') ?>" method="post" onsubmit="addData()">
                                ...
                                <div class="m-t-20 text-center">
                                    <button type="submit" class="btn btn-success submit-btn">Create Schedule</button>
                                </div>
        ...
        <div class="page-wrapper" style="padding:50px 0px;">
            <div class="content">
                ...
                <?php if (isset($schedule)) : ?>
                    <div class="row p-3">
                        <div class="col-lg-8 offset-lg-2">
                            <form action="<?php echo site_url('doctorProfile_Controller/editSchedule/' . $this->uri->segment(3)) ?>" method="post">
                                <div class="row pt-3 pb-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Doctor Name</label>
                                ...
                                <div class="m-t-20 text-center">
                                    <button type="submit" class="btn btn-success submit-btn">Save Schedule</button>
                                </div>
                            </form>
                        </div>
                    </div>
