<?php
// $q = $this->db->where('doc_id',$_SESSION['doc_id'])->get('doctor_details')->result_array();
// echo "<pre>";
// print_r($_SESSION);
// die;
?>
...
<head>
    ...
    <style>
        .navbar {
            background-color: rgb(10, 160, 10) !important;
        }
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto mr-4">
                ...
                <li class="nav-item">
                    ...
                    $q = $this->db->where('doc_id', $_SESSION['doc_id'])->get('doctor_details')->result_array(); ?>
                    <a class="nav-link"><?php echo "Dr." . $q[0]['doc_name']   ?></a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="<?php echo $q[0]['picture'] === "" ? base_url("images/avatar.png") : $q[0]['picture'] ?>" class="img rounded-circle" style="height: 26px;width:30px;" alt="profilepic">
                    </a>

                    <div class="dropdown-menu mt-2 dropdown-menu-right" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="<?php echo site_url('doctorProfile_Controller/profile')
                                                        ?>">View Profile</a>
                        <a class="dropdown-item" href="<?php echo site_url('doctorProfile_Controller/edit_doc_profile/' . $_SESSION['doc_id'])
                                                        ?>">Edit Profile</a>
        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li <?php if ($this->uri->segment(2) == 'doctor-schedule') : ?> class="active" <?php endif; ?>>

                        <a href="<?php echo site_url('doctor/doctor-schedule') ?>"><i class="fas fa-calendar-check"></i> <span>Doctor's Schedule</span></a>
                    ...
                    <li <?php if ($this->uri->segment(2) == 'appointments') : ?> class="active" <?php endif; ?>>
                        ...
                        <a href="<?php echo site_url('doctor/appointments') ?>"><i class="fa fa-calendar"></i> <span>Appointments</span></a>
                    ...
                    <!-- 
                    <li <?php //if ($this->uri->segment(2) == 'doctor-prescription') : 
                        ?> class="active" <? // php // endif; 
                                            ?>>
                    <a href="<?php //echo site_url('doctor/doctor-prescription') 
                                ?>"><i class="fas fa-file-prescription"></i><span>Prescription</span></a>
