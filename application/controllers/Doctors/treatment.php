								...
								<tbody>
									...
									<?php foreach ($patients as $x) : ?>
										...
										<tr class="searchtrt">
											...
											<td data-th="Medication:"><button type="button" class="btn btn-success" data-toggle="modal" data-target="#MedicationModal<?php echo $x['p_id']; ?>">

													View Medications

												</button></td>

											<td data-th="View Details:"><button type="button" class="btn btn-success" data-toggle="modal" data-target="#<?php echo $x['p_id']; ?>exampleModalLong">
