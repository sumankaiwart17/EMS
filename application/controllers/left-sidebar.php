...
<body>
  ...
  <div id="sidebar"data-aos="fade-down"

      class="<?php if ($this->uri->segment(2) == 'compare' || $this->uri->segment(2) == 'recHospital') : ?>col-sm-2 text-right<?php else : echo 'col-sm-2';

                                                                                                                                        endif; ?> left-bar-desk"

      <?php if ($this->uri->segment(2) == 'compare') { ?> styles="padding-left: 100px !important;" <?php } ?>>



      <div id="recommend">

          <a href="<?php echo site_url('user/recommend-me') ?>"

              class="btn text-white btn-md <?php if ($this->uri->segment(2) != 'recommendMe') {
          ...
          <p class="ml-2 mb-0">
              ...
              <a
                  ...
                  href="<?php echo site_url('userProfile_Controller/recommendMe?t=' . $x['treat_id'] . '&b=' . $x['budget']) ?>"><?php echo $x['treat_name'] ?></a><br>
      ...
      <div id="compare" class="mb-3 mt-3">
          ...
          <a href="<?php echo site_url('userProfile_Controller/compare') ?>"
              ...
              class="btn text-white btn-lg <?php if ($this->uri->segment(2) == 'compare' || $this->uri->segment(2) == 'compareSelected') {
      ...
      <div id="" class="pl-1 mb-3">
          ...
          <a href="#" data-toggle="modal" data-target="#exampleModal">
              ...
              <h5 class="sidebar-header">My Preferences</h5><a>

                  <p>

                      <?php if ($userData[0]['treatment'] != '') { ?>

                      <a

                          href="<?php echo site_url('userProfile_Controller/recommendMe?t=' . $x[0]['treat_id'] . '&b=50000') ?>">
      ...
      <div id="" class="pl-1 mb-3">
          ...
          <a href="#">
              ...
              <h5 class="sidebar-header">Most Searched</h5>
          ...
          <a
              ...
              href="<?php echo site_url('userProfile_Controller/recommendMe?t=' . $x['treat_id'] . '&b=' . $x['budget']) ?>"><span

                  class="badge badge-pill badge-secondary"><?php echo $x['treat_name'] ?></span></a>
      ...
      <div id="" class="pl-1 mb-3">
          ...
          <p>
              ...
              <a href="<?php echo site_url('appointment_Controller/offerBooking/' . $Leftoffer[$i]['coupon_code']) ?>"><span

                      class="text-danger font-weight-bold"><?php echo $Leftoffer[$i]['discount'] . '% OFF-' . $Leftoffer[$i]['hos_name'] . '</span>&nbsp;' . $Leftoffer[$i]['coupon_title']; ?></a><br>
  ...
  <div class="wrapper" id="chat_window" style="display: none;">
      ...
      <div class="title">AAHRS Chatbot<span id="chat_close" class="mr-2" style="cursor: pointer; float: right;"><i
      ...
      <div class="form">
          ...
          <div class="bot-inbox inbox">
              ...
              <div class="container actions FAQs-actions" style="display:none;">
                  ...
                  <span class="options badge faq_ques"

                      data-value="<?php echo $x['answer'] ?>"><?php echo $x['question'] ?></span>

                  <?php endforeach; ?>

                  <!-- <div class="options badge" data-value="chat"><h3>FAQ 2</h3></div><br>

                <div class="options badge" data-value="chat"><h3>FAQ 3</h3></div><br>

                <div class="options badge" data-value="chat"><h3>FAQ 4</h3></div><br>

                <div class="options badge" data-value="chat"><h3>FAQ 5</h3></div><br>

                <div class="options badge" data-value="chat"><h3>FAQ 6</h3></div><br>

                <div class="options badge" data-value="chat"><h3>FAQ 7</h3></div><br> -->
...
#about1 {
  ...
  <div class="emBtn">
      ...
      <a data-toggle="modal" data-target="#emergencyModal" class="btn"><img

              src="<?php echo base_url('images/em-icon.png') ?>" style="height:50px;width:50px;" alt=""></a>

  </div>

  <form method="post" action="<?php echo site_url('emergency_controller/emergency') ?>">

      <div class="modal fade" id="emergencyModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <div class="form-group">
                          ...
                          <input type="number" class="form-control" placeholder="Enter Phone number" name="pnum"
