...
<body class="bg-body">
    ...
    <div class="container-fluid mt-2">
                ...
                <form action="<?php echo site_url('UserProfile_Controller/compareSelected') ?>" method="post">
                    <div class="searchBar row mt-3">
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-3">
                            <input type="text" name="search" id="search" class="form-control" value="" placeholder="Search Hospitals">
                        </div>
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-3">
                            <a class="btn btn-primary btn-lg btn-block " id="reset">
                                <p class="text-weight-bolder p-0 m-0 text-white"> Reset</p>
                        ...
                        <div class="row compareData mt-3">
                            ...
                            <div class="col-12  mt-2">
                                ...
                                <h3>Select up to 5 Hospitals to compare
                                    ...
                                    <span class="badge badge-rounded badge-white selected float-right" style="border: 2px solid green;margin-left:10px;">0/5 selected</span>
        ...
        <ul class="hosData mt-3 pb-5" data-aos="fade-left">
            ...
            if (isset($topHos)) {
                foreach ($topHos as $x) : ?>
                    <li class="booking-card" style="background-image: url(<?php echo $x['logo'] == "" ? base_url('images/hos.png') : base_url('userUploads/' . $x['logo']) ?>);background-repeat: no-repeat;background-position: 0px 0px;background-size: 220px 220px;">
                        <label class="label">
    ...
    <div id="sidebar" class="col-sm-2">
        <div id="recommend" class=" mb-3">
            <a href="<?php echo site_url('userProfile_Controller/postReview') ?>" class="btn text-white btn-md font-weight-bold btn-danger">Post a Review</a>
        </div>
        ...
        <div id="" class=" mb-3">
            ...
            <p><input type="radio" class="filterCheck" name="sort" id="" checked value="">&nbsp;<label for="">All</label><br>
                <input type="radio" class="filterCheck" name="sort" id="highRate" value="highRate">&nbsp;<label for="highRate">Higest Rating</label><br>
                <input type="radio" class="filterCheck" name="sort" id="lowRate" value="highRate">&nbsp;<label for="lowRate">Lowest Rating</label><br>
            </p>
        </div>
        ...
        <div id="" class=" mb-3">
            ...
            <div>
                ...
                <input type="checkbox" class="filterCheck" id="star_rate" value="5">&nbsp;<label for="5"><i class="fas fa-star text-warning"></i><i class="fas fa-star text-warning"></i><i class="fas fa-star text-warning"></i><i class="fas fa-star text-warning"></i><i class="fas fa-star text-warning"></i></label><br>
                <input type="checkbox" class="filterCheck" id="star_rate" value="4">&nbsp;<label for="4"><i class="fas fa-star text-warning"></i><i class="fas fa-star text-warning"></i><i class="fas fa-star text-warning"></i><i class="fas fa-star text-warning"></i></label><br>
                <input type="checkbox" class="filterCheck" id="star_rate" value="3">&nbsp;<label for="3"><i class="fas fa-star text-warning"></i><i class="fas fa-star text-warning"></i><i class="fas fa-star text-warning"></i></label><br>
                <input type="checkbox" class="filterCheck" id="star_rate" value="2">&nbsp;<label for="2"><i class="fas fa-star text-warning"></i><i class="fas fa-star text-warning"></i></label><br>
                <input type="checkbox" class="filterCheck" id="star_rate" value="1">&nbsp;<label for="1"><i class="fas fa-star text-warning"></i></label><br>
