<?php //echo "<pre>";print_r($treats);die; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="row m-1 p-1" data-aos="fade-right" style="width: 100%; border-radius:5px;">
                            <div class="form-group col-12 col-sm-6 col-md-6 col-lg-3 ">
                                ...
                                <select name="treatname" class="form-control" id="treatname">
                                    ...
                                    <?php foreach ($treats as $x) : ?>
                                        <option <?php if (isset($preSearch) && $preSearch['treat_id'] == $x['treat_id']) {
                                                    echo "selected";
                            ...
                            <div class="form-group col-12 col-sm-6 col-md-6 col-lg-3 ">
                                ...
                                <select name="budget" class="form-control" id="budget">
                                    ...
                                    <option value="25000">
                                        Less than 25,000 INR</option>
                                    <option value="50000">
                                        Less than 50,000 INR</option>
                                </select>
                            </div>
                    ...
                    <div class="col-12 bg-white">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <ul class="hosData">
                                ...
                                <li class="card card-body" data-aos="fade-left" style="max-width: 99%; height:65px; border-radius:0px;border-left: 4px ridge red; box-shadow: 0px 0px 0px">
                                    ...
                                    <li class="bc-banner text-center" data-aos="fade-up">
                                        ...
                                        <a href="#">
                                            ...
                                            <div class="bc-banner-body">
                                                ...
                                                <a href="<?php echo site_url('userProfile_Controller/adDetails?id=') . $data[0]['ad_id'] ?>" class="btn btn-primary">View Details</a>
                                            </div>
                                            <img src="<?php echo base_url('images/dd.jpg') ?>" alt="aahrs" class="bc-banner-cover img-responsive">
                                        </a>
                                    </li>
                                <?php endif; ?>
                            </ul>
