        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                ...
                <form class="d-flex mb-2">
                    ...
                    <input class="form-control me-2" id="myInput" type="text"  placeholder="Search offers..">
                ...
                <div class="panel-group" id="accordion" style="height: 800px; overflow-y: scroll; width: 100%; padding: 0px 30px" role="tablist" aria-multiselectable="true">
                        ...
                        foreach ($offers as $x) : ?>
                            ...
                            <?php if ($x['status'] != 0) : ?>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-heading" id="getOff" role="tab" id="<?php echo $x['coupon_id'] ?>">
                                        ...
                                        <div class="panel-body container pt-0">
                                            ...
                                            <div class="row pt-0 mt-0">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <img src="<?php echo base_url('userUploads/' . $x['logo']) ?>" class="img-thumbnail float-left" style="border:0px; height:80px; width:80px;" alt="">
                    ...
                    <?php endforeach;
                        ...
                        echo "<label style='color:red'>No Offer Found!! </label>";
                    }
                    ?>
