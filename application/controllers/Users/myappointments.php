                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($docappoint as $x) : ?>
                                            ...
                                            <tr style="margin-bottom: 5px;">
                                                ...
                                                <td data-th="Pt Name"><?php echo $x['pt_name'] ?></td>

                                                <!-- <td data-th="Pt Phone"><?php echo $x['phone'] ?></td> -->
                    ...
                    <div class="card p-2 card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <p class="m-0 p-0" style="font-size:16px;"><?php echo $doc[0]['department'] ?> <small style="" class="text-muted">over 12 years of experience</small></p>
                                <p class="m-0 p-0" style="font-size:16px;"><?php echo " Email: " . $doc[0]['d_email'] ?></p>
                                <p class="m-0 p-0" style="font-size:16px;"><?php echo " Contact no:" . $doc[0]['d_phone'] ?></p>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 pt-2">
                                <div class="form-group">
                                    <h5 style="font-size:16px;">Booked on: <?php echo date('d-m-Y h:i:s A', strtotime($doc[0]['booking_datetime'])) ?> </h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 pt-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <h5 style="font-size:16px;">Booked on:

                                        <?php


                                        echo date($trt[0]['booking_datetime'])
