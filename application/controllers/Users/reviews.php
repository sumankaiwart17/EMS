            ...
            <div class="row mb-5">
                ...
                <div class="col-sm-12 col-lg-8 bg-body mb-3 revData" data-aos="fade-up">
                    ...
                    <?php if (!isset($reviews)) : ?>
                        ...
                        <div class="text-danger">No Reviews Added</div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <h5 class="pt-2"><a href="<?php echo site_url('userProfile_Controller/myaccount?id=' . base64_encode($x['email_id'] . '')) ?>"><?php echo ucfirst($x['name']); ?></a>
                                                ...
                                                <?php elseif (isset($x['hos_name'])) : ?>
                                                    ...
                                                    <a href="<?php echo site_url('MainController/viewHospital/'.$x['hos_id']) ?>" class="rev-sub font-weight-bold"><?php echo $x['hos_name'];  ?></a>    
                                                ...
                                                <div class="modal-title" id="exampleModalLongTitle" style="width:100%;">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <?php else : ?>
                                                                <img src='<?php echo base_url('images/avatar.png') ?>' class="img-thumbnail mr-3 float-left rounded-circle" style="height: 70px; width:70px;" />
                                                            <?php endif; ?>
                        ...
                        <div>
                            ...
                            <div class="shown">
                                <?php if (isset($filters) && $filters['hos'] !== '') : ?>
                                    <input type="radio" name="hos_id" value='' class="filterCheck" id="hos_id">&nbsp;<label><?php echo 'All' ?></label><br>
                                    ...
                                    foreach ($filters['hos'] as $x) :
                                        $c++;
                                    ?>
                                        <input type="radio" name="hos_id" class="filterCheck" id="hos_id" value="<?php echo $x['hos_name'] ?>">&nbsp;<label for="<?php echo $x['hos_id'] ?>"><?php echo $x['hos_name'] ?></label><br>
                            ...
                            <div class="hidden2" style="height: 125px; overflow-y: scroll; width: 185px;">
                                ...
                                <?php $c = 0;
                                    foreach ($filters['hos'] as $x) :
                                        $c++;
                                ?>
                                    <p style="margin-bottom:0px;"><input type="radio" id="hos_id" name="hos_id" class="filterCheck filterCheckhos" id="hos_id" value="<?php echo $x['hos_name'] ?>"><?php echo ' ' . $x['hos_name'] ?></p>
                            ...
                            <div class="shown">
                                <?php if (isset($filters) && ($filters['docs'] !== '')) : ?>
                                    ...
                                    foreach ($filters['docs'] as $x) :
                                        $c++;
                                    ?>
                                        <input type="radio" name="doc" class="filterCheck1" id="doc_id" value="<?php echo $x['doc_name'] ?>">&nbsp;<label for="<?php echo $x['doc_id'] ?>"><?php echo $x['doc_name']
                                ...
                                <div class="hidden2" style="height: 125px; overflow-y: scroll; width: 185px;">
                                    ...
                                    ?>
                                        <p style="margin-bottom:0px;">
                                            <input type="radio" name="doc" class="filterCheck1 filterCheckdoc" id="doc_id" value="<?php echo $x['doc_name'] ?>"><?php echo ' ' . $x['doc_name'] ?>
                                        </p>
