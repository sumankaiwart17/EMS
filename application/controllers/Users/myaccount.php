                            ...
                            <form action="<?php echo site_url('userProfile_Controller/myaccount') ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        ...
                                        <button href="javascript:void(0);" class="btn mob-btn btn-primary btn-danger cancel mr-2">Cancel</button>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="profile-upload">
                                                ...
                                                <div class="upload-img">
                                                    ...
                                                    <img alt='' id="prevpic" class="img-fluid " style="background-color:transparent;background-position:center;margin:0 0px 20px 0px;border-radius:5px;height: 100px; width: 100px" src="<?php echo $userdata[0]['picture'] == '' ? base_url('images/avatar.png') : $userdata[0]['picture']; ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" required name="email_id" type="email" readonly value="<?php echo $userdata[0]['email_id'] ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="city" required class="form-control" value="<?php echo $userdata[0]['city'] ?>">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="state" required class="form-control " value="<?php echo $userdata[0]['state'] ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="country" required class="form-control " value="<?php echo $userdata[0]['country'] ?>">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" required name="zip" required class="form-control" value="<?php echo $userdata[0]['zip'] ?>">
