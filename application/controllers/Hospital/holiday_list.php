                    ...
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <form action="<?php echo site_url('hospital_Controller/add_holiday') ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="holiday_name" type="text" value="<?php echo set_value('holiday_name'); ?>">

                                <span class="text-danger"><?php echo form_error('holiday_name'); ?></span>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control"  name="holiday_date" type="date" value="<?php echo set_value('holiday_date'); ?>">
            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <form action="<?php echo site_url('hospital_Controller/edit_holiday/'.$this->uri->segment(3)) ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <!-- <div class="cal-icon"> -->
                                    ...
                                    <input value="<?php echo $holiday[0]['holiday_date'] ?>" class="form-control" name="holiday_date" type="date" >
