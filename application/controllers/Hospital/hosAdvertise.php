            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-4 search-bar">
                        <input type="text" class="form-control mb-3" placeholder="Search Advertisement" id="search">
                            ...
                            <table class="table table-striped custom-table">
                                ...
                                <tbody>
                                    ...
                                    <?php else : ?>
                                        ...
                                        <?php echo "<span style='color:red'>No Advertisement</span><script>document.getElementById('hideData').style.display='none'</script>" ?>
                                    <?php endif; ?>
            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 offset-lg-2 pt-3">
                        ...
                        <form method="post" action="<?php echo site_url('hospital_Controller/addAdvertise') ?>" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 pt-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="ad_title" id="ad_title" type="text" value="<?php echo set_value('ad_title') ?>">

                                        <span class="text-danger"><?php echo form_error('ad_title') ?></span>
                                ...
                                <div class="col-sm-6 pt-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="ad_desc" id="ad_desc" type="text" value="<?php echo set_value('ad_desc') ?>">

                                        <span class="text-danger"><?php echo form_error('ad_desc') ?></span>
            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 offset-lg-2 pt-3">
                        ...
                        <form method="post" action="<?php echo site_url('hospital_Controller/editAdvertise/' . $this->uri->segment(3)) ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 pt-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="ad_title" id="ad_title" type="text" value="<?php echo $ad[0]['ad_title'] ?>">
                                ...
                                <div class="col-sm-6 pt-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="ad_desc" id="ad_desc" type="text" value="<?php echo $ad[0]['ad_desc'] ?>">
                                ...
                                <div class="col-sm-6 pt-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="image" id="image" type="file">
                                        <input class="form-control" name="oldimage" value="<?php echo $ad[0]['image'] ?>" type="hidden">
                                    ...
                                    <div class="form-group gender-select">
                                        ...
                                        <div class="form-check-inline">
                                            ...
                                            <label class="form-check-label">
                                                ...
                                                <input type="radio" name="status" value="1" <?php if ($ad[0]['status'] == 1) {
                                        ...
                                        <div class="form-check-inline">
                                            ...
                                            <label class="form-check-label">
                                                ...
                                                <input type="radio" name="status" value="0" <?php if ($ad[0]['status'] == 0) {
                            ...
                            <div class="m-t-20 text-center">
                                ...
                                <button type="submit" class="btn btn-primary submit-btn">Edit Advertisement</button>
