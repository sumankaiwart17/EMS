            ...
            <div class="content" style="height:100vh;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 col-5" data-aos="fade-right">
                        ...
                        <h4 class="page-title">Treatments & Packages</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 search-bar">
                        ...
                        <input type="text" class="form-control mb-3" placeholder="Search Treatments" id="search">
                                                ...
                                                <td data-th="Action:" class="text-right">
                                                    ...
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item" href="<?php echo site_url('hospital_Controller/delTreat/' . $y['treat_id']) ?>" onclick="return confirm('Are you sure, you want to delete this treatment ?')"><i class="fas fa-trash m-r-5"></i> Delete</a>
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <form action="<?php echo site_url('hospital_Controller/addTreat') ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select id="deptName" name="deptName" class="form-control">
                                    ...
                                    <?php if ($depts !== '') : ?>
                                        ...
                                        <?php foreach ($depts as $x) : ?>
                                            ...
                                            <option value="<?php echo $x['dept_id'] . "" . $x['dept_name'] ?>"><?php echo $x['dept_name'] ?></option>
                                ...
                                <span class="text-danger"><?php echo form_error('deptName'); ?></span>
                                <br>
                            ...
                            <div class="form-group">
                                ...
                                <span class="text-danger"><?php echo form_error('treatName'); ?></span>
                                ...
                                <div data-parent="other" style="display: none; margin-top: 20px;">
                                    ...
                                    <span class="text-danger"><?php echo form_error('newTreatName'); ?></span>
            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <form action="<?php echo site_url('hospital_Controller/edittreat/' . $this->uri->segment(3)) ?>" method="post">
