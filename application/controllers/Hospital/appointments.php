                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select id="apptt_on" name="appt_on" value="Doctor" required class="form-control">
                                        ...
                                        <div class="col-md-6 doc">
                                            <div class="form-group">
                                                ...
                                                <div class="text-danger"><?php echo form_error('dept_id'); ?></div>
...
<?php endif;?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label> Fees</label>
                                                <input class="form-control" id="fees" type="number" name="fees" readonly>
                                            </div>
                                        </div>
                    ...
                    <!-- slots come according to doctors -->
                    <script>
                        $("#doc_id").change(function() {
                            ...
                            $.ajax({
                                ...
                                url: "<?php echo base_url('hospital_Controller/getSlots') ?>",
                    ...
                    <script>
                        $("#doc_id").change(function() {
                            ...
                            $.ajax({
                                ...
                                url: "<?php echo base_url('hospital_Controller/getfees') ?>",
                                success: function(data) {
                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 offset-lg-2">
                                ...
                                <form method="POST" action="<?php echo site_url('hospital_Controller/edit_appointment_data/' . $this->uri->segment(3)); ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="dept_id" name="dept_id">
                                                    ...
                                                    <?php foreach ($departments as $x) { ?>
                                                        ...
                                                        <?php if ($x['dept_name'] == $dept[0]['dept_name']) { ?>
            ...
            <script>
                ...
                $.ajax({
                        ...
                        url: "<?php echo site_url('hospital_Controller/get_doc_degee') ?>",
                        success: function(data) {
            ...
            <script>
                $(document).ready(function() {
                    $("#calendar<?php echo $_SESSION['doc_id'] ?>").on('change', function() {
                        var date = $(this).val();
            ...
            <script type="text/javascript">
                ...
                $(function() {
                    ...
                    $doctors = $this->db->select('doctor_details.*,doctors_schedule.*')->from('doctor_details')
                        ->where('doctor_details.doc_id', $_SESSION['doc_id'])
                        ->join('doctors_schedule', 'doctors_schedule.doc_id=doctor_details.doc_id')
                        ->get()
                        ->result_array();

                    $onDays = explode(',', $doctors[0]['weekdays']);
                    $disabDays = array();
