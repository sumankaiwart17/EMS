									...
									<li>
										...
										<div class="contact-cont">
											...
											<div class="float-left user-img m-r-10">
												...
												<a href="profile.html" title="John Doe"><img src="<?php echo $x['picture'] === "" ? base_url("images/avatar.png") : $x['picture']; ?>" alt="" style="width:40px;height:40px;" class="rounded-circle"><span class="status online"></span></a>
