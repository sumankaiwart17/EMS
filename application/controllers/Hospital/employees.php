                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="emp_name" id="emp_name" type="text" value="<?php echo set_value('emp_name'); ?>">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="join_date" id="join_date" value="<?php echo set_value('join_date'); ?>">
            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <form method="POST" action="<?php echo site_url('hospital_Controller/editEmp/' . $this->uri->segment(3)); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="emp_name" value="<?php echo $empData[0]['emp_name']; ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="email" name="email" value="<?php echo $empData[0]['email']; ?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="mobile" value="<?php echo $empData[0]['mobile']; ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="join_date" value="<?php echo $empData[0]['join_date']; ?>">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="role" class="form-control">
                                            ...
                                            <option <?php echo $empData[0]['role'] === "Admin" ? "selected" : "";   ?>>Admin</option>

                                            <option <?php echo $empData[0]['role'] === "Nurse" ? "selected" : "";   ?>>Nurse</option>

                                            <option <?php echo $empData[0]['role'] === "Laboratorist" ? "selected" : "";   ?>>Laboratorist</option>

                                            <option <?php echo $empData[0]['role'] === "Pharmacist" ? "selected" : "";   ?>>Pharmacist</option>

                                            <option <?php echo $empData[0]['role'] === "Accountant" ? "selected" : "";   ?>>Accountant</option>

                                            <option <?php echo $empData[0]['role'] === "Receptionist" ? "selected" : "";   ?>>Receptionist</option>
                            ...
                            <div class=" form-group">
                                ...
                                <span class="text-danger"><?php echo form_error('stat'); ?></span>
