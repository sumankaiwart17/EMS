...
<head>
    ...
    <link rel="stylesheet" href="http://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.2/css/all.min.css" integrity="sha512-HK5fgLBL+xu6dm/Ii3z4xhlSUyZgTT9tuc/hSrtw6uzJOvgRr2a9jyxxT1ely+B+xFAmJKVSTbpM/CuL7qxO8w==" crossorigin="anonymous" />
...
Z
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" style="z-index:1;" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item"
                                ...
                                href="<?php echo site_url('userProfile_Controller/medicalHis') ?>"></a>
    ...
    <header class="bg-flor">
        <div class="container">
            <nav>
                <div class="logo">
                    <img src="<?php echo base_url('images/AAHRS_logo5.png') ?>" alt="logo">
                </div>
                ...
                <ul>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <?php if(isset($data)):?>
                            <img src="<?php  echo base_url()."userUploads/". $data['picture']
                                            ?>" class="img rounded-circle" 
                             style="height: 40px;width:40px;" alt="profilepic">

                            <?php if (isset($userData) ||($userData[0]['picture']=='')) : ?>
                                <img src="<?php echo $userData[0]['picture'] ?>" alt="" class="img-fluid rounded-circle" style='width:40px;height:40px;box-shadow:5px 5px 5px .5' alt="">
                            <?php else : ?>

                                <img src="<?php echo base_url('images/avatar.png') ?>" style='width:30px;height:30px;border-radius:10px' alt="logo">
                            <?php endif ?>
    ...
    <div class="container mt-3">
        ...
        <div class="row desk-nav justify-content-center">
            ...
            <div class=" col-12 col-sm-6 col-md-2 col-lg-2 text-center"><a href="<?php echo site_url('user/timeline') ?>" class="user-link <?php if ($this->uri->segment(2) == 'timeline') : ?> <?php echo 'active' ?> <?php endif; ?>" class="user-link">Timeline</a></div>

            <div class=" col-12 col-sm-6 col-md-2 col-lg-2 text-center"><a href="<?php echo site_url('user/reviews') ?>" class="user-link <?php if ($this->uri->segment(2) == 'reviews') : ?> <?php echo 'active' ?> <?php endif; ?>">Reviews</a>

            </div>

            <div class=" col-12 col-sm-6 col-md-2 col-lg-2 text-center"><a href="<?php echo site_url('user/top-hospitals') ?>" class="user-link <?php if ($this->uri->segment(2) == 'top-hospitals') : ?> <?php echo 'active' ?> <?php endif; ?>">Top

                    Hospitals</a></div>

            <div class=" col-12 col-sm-6 col-md-2 col-lg-2 text-center"><a href="<?php echo site_url('user/top-doctors') ?>" class="user-link <?php if ($this->uri->segment(2) == 'top-doctors') : ?> <?php echo 'active' ?> <?php endif; ?>" class="user-link">Appointment Booking</a></div>

        </div>

        <div class="row mob-nav justify-content-center">

            <div class=" col-3 col-sm-3 text-center"><a href="<?php echo site_url('user/timeline') ?>" class="user-link <?php if ($this->uri->segment(2) == 'timeline') : ?> <?php echo 'active' ?> <?php endif; ?>" class="user-link">
            ...
            <div class=" col-3 col-sm-3 col-md-2 col-lg-2 text-center"><a href="<?php echo site_url('user/reviews') ?>" class="user-link <?php if ($this->uri->segment(2) == 'reviews') : ?> <?php echo 'active' ?> <?php endif; ?>">
            ...
            <div class=" col-3 col-sm-3 col-md-2 col-lg-2 text-center">
                <a href="<?php echo site_url('user/top-hospitals') ?>" class="user-link <?php if ($this->uri->segment(2) == 'top-hospitals') : ?> <?php echo 'active' ?> <?php endif; ?>">
            ...
            <div class=" col-3 col-sm-3 col-md-2 col-lg-2 text-center"><a href="<?php echo site_url('user/top-doctors') ?>" class="user-link <?php if ($this->uri->segment(2) == 'top-doctors') : ?> <?php echo 'active' ?> <?php endif; ?>" class="user-link">
    ...
    <script src="http://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous">

    </script>

    <script src="http://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>

    <script src="http://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous">
