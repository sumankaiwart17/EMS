...
$pdf->setFootuserUploadsArray(PDF_FONT_NAME_DATA, '', PDF_FONT_SIZE_DATA));
...
if (@file_exists(dirname(__FILE__).'/lang/eng.php')) {
	...
	require_once(duserUploads__FILE__).'/lang/eng.php');
