...
userUploadsuserUploadsuserUploadsuserUploadsuserUploadsuserUploadsuserUploadsuserUploads
...
if (!defined('PDF_HEADER_LOGO')) {
	...
	if (@file_exists(K_PATH_MAIN.'include/final.jpg')) {

		$tcpdf_header_logo = K_PATH_MAIN.'include/final.jpg';
