        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-9 text-right m-b-20" data-aos="fade-left">
                    ...
                    <a href="<?php echo site_url('hospital_Controller/addDoc') ?>"
                        class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Doctor</a>
            ...
            <div class="row doctor-grid">
                ...
                <div class="col-md-4 col-sm-4  col-lg-3">
                    ...
                    <div class="profile-widget" data-aos="flip-up" >
                        ...
                        <div class="dropdown profile-action">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item"
                                    href="<?php echo site_url('hospital_Controller/editDoc/' . $x['doc_id']) ?>"><i
                                        class="fas fa-pencil-alt m-r-5"></i> Edit</a>

                                <a class="dropdown-item"
                                    href="<?php echo site_url('hospital_Controller/delDoc/' . $x['doc_id']) ?>"
                        ...
                        <h4 class="doctor-name text-ellipsis"><a data-toggle="modal"
                                data-target="#exampleModalCenter<?php echo $modal ?>"
                                href="profile.html"><?php echo $x['doc_name'] ?></a></h4>

                        <div class="doc-prof"><?php echo $x['specialization'] //$x['dept_name'] ?></div>
                 ...
                 <div class="modal fade" id="exampleModalCenter<?php echo $modal ?>" tabindex="-1" role="dialog"
                                ...
                                <div class="conatainer-fluid">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            ...
                                            <img src="<?php echo $x['picture'] ?>" class="img-thumbnail rounded-square"
                                                alt="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6 mt-2">
                                            ...
                                            <p class="text-info"><strong
                                                    style="border-bottom: 2px solid #17a2b8!important">
                                                    Address:</strong></p>
        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <form action="<?php echo site_url('hospital_Controller/addDoc') ?>" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group" data-aos="fade-left">
                                    ...
                                    <input class="form-control" placeholder="Enter Medical Council Registrations Number" name="registration_num" id="regis_num"
                                        type="number" value="<?php echo set_value('registration_num') ?>" required >
<!-- onchange="get_regis()" -->
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group" data-aos="fade-right">
                                    ...
                                    <input class="form-control" placeholder="Please Enter Name" name="docName"
                                        type="text" value="<?php echo set_value('docName') ?>" required>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group" data-aos="fade-left">
                                    ...
                                    <input class="form-control" placeholder="Please Enter Email" name="emailId"
                                        type="email" value="<?php echo set_value('emailId') ?>" required>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group" data-aos="fade-right">
                                    ...
                                    <input class="form-control" placeholder="Please Enter Mobile Number" name="phone"
                                        type="text" value="<?php echo set_value('phone') ?>" required>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group" data-aos="fade-left">
                                    ...
                                    <input type="number" placeholder="Please Enter Adhar No" name="adhar"
                                        class="form-control " value="<?php echo set_value('adhar') ?>" required>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group" data-aos="fade-right">
                                    ...
                                    <input class="form-control" placeholder="Passsword Atleast 6 Char" name="pass"
                                        type="password" value="<?php echo set_value('pass') ?>" required>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group" data-aos="fade-left">
                                    ...
                                    <input class="form-control" placeholder="Confirm Password Must Match" name="cpass"
                                        type="password" value="<?php echo set_value('cpass') ?>" required>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group" data-aos="fade-right">
                                    ...
                                    <input class="form-control" placeholder="Please Enter Experience" name="experience"
                                        type="number" value="<?php echo set_value('experience') ?>" required>
                            ...
                            <div class="col-sm-6">
                             ...
                             <div class="col-sm-6" style = "display:none;" id = "Other_degree" data-aos="fade-left" >
                                ...
                                <div class="form-group" data-aos="fade-left">
                                    ...
                                    <input class="form-control" placeholder="Please Enter Other Degree" name="Others"
                                        type="text" value="<?php echo set_value('Others') ?>">
                            ...
                            <div class="col-sm-6" style="display:none" id="dis_specialization">
                             ...
                             <div class="col-sm-6" style = "display:none;" id = "Other_specialization" >
                                ...
                                <div class="form-group" data-aos="fade-left">
                                    ...
                                    <input class="form-control" placeholder="Please Enter Other Specialization" name="Other_specialization"
                                        type="text" value="<?php echo set_value('Other_specialization') ?>">
                            ...
                            <div class="col-sm-6" style = "display:none;" id = "Other_speciality" >
                                ...
                                <div class="form-group" data-aos="fade-left">
                                    ...
                                    <input class="form-control" placeholder="Please Enter Other Speciality" name="Other_speciality"
                                        type="text" value="<?php echo set_value('Other_speciality') ?>" style = "margin-top: 10px;">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group" data-aos="fade-left">
                                    ...
                                    <input class="form-control" placeholder="Please Enter About" name="about"
                                        type="text" value="<?php echo set_value('about') ?>">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group" data-aos="fade-right">
                                    ...
                                    <input class="form-control" placeholder="Please Enter Services" name="services"
                                        type="text" value="<?php echo set_value('services') ?>">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group" data-aos="fade-left">
                                    ...
                                    <label>Awards & recognition</label>
                                       ...
                                       <input class="form-control" placeholder="Please Enter Awards" name="awards"
                                     type="text" value="<?php echo set_value('awards') ?>">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group" data-aos="fade-right">
                                    ...
                                    <input class="form-control" placeholder="Please Enter Certifications" name="certifications"
                                        type="text" value="<?php echo set_value('certifications') ?>">
                                ...
                                <div class="form-group" data-aos="fade-right">
                                    ...
                                    <div class="profile-upload">
                                        ...
                                        <div class="upload-input">
                                            ...
                                            <input type="file" class="form-control" id="propic" name="signature" required>
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-3">
                                        ...
                                        <div class="form-group" data-aos="fade-left">
                                            ...
                                            <input type="text" name="zip" class="form-control" placeholder="Enter Postal Code"
                                                value="<?php echo set_value('zip') ?>" required>
        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <form action="<?php echo site_url('hospital_Controller/editDoc') ?>" method="post"
                        enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="registration_num" readonly type="text"
                                        value="<?php echo $docReg['registration_num'] ?>">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="docName" type="text"
                                        value="<?php echo $docReg['doc_name'] ?>">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="specialization" class="form-control "
                                        value="<?php echo $docDet['specialization'] ?>">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="emailId" type="email"
                                        value="<?php echo $docDet['email_id'] ?>">
                             ...
                             <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="speciality" class="form-control "
                                        value="<?php echo $docDet['speciality'] ?>">
                             ...
                             <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="experience" class="form-control "
                                        value="<?php echo $docDet['experience'] ?>">
                             ...
                             <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="services" class="form-control "
                                        value="<?php echo $docDet['services'] ?>">
                             ...
                             <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="certifications" class="form-control "
                                        value="<?php echo $docDet['certifications'] ?>">
